...
{
public partial class UsuariosEN
{
/**
 *
 */
...
public UsuariosEN(string contraseña, string nombre)
{
        this.init (contraseña, nombre);
}


public UsuariosEN(UsuariosEN usuarios)
{
        this.init (usuarios.Contraseña, usuarios.Nombre);
}
...
public override bool Equals (object obj)
{
        if (obj == null)
                return false;
        UsuariosEN t = obj as UsuariosEN;
        if (t == null)
                return false;
