...
public static void InitializeData ()
{
        ...
        try
        {
                /*List<VeterinaryManagerGenNHibernate.EN.Mediaplayer.MusicTrackEN> musicTracks = new List<VeterinaryManagerGenNHibernate.EN.Mediaplayer.MusicTrackEN>();
                 * VeterinaryManagerGenNHibernate.EN.Mediaplayer.UserEN userEN = new VeterinaryManagerGenNHibernate.EN.Mediaplayer.UserEN();
                 * VeterinaryManagerGenNHibernate.EN.Mediaplayer.ArtistEN artistEN = new VeterinaryManagerGenNHibernate.EN.Mediaplayer.ArtistEN();
                 * VeterinaryManagerGenNHibernate.EN.Mediaplayer.MusicTrackEN musicTrackEN = new VeterinaryManagerGenNHibernate.EN.Mediaplayer.MusicTrackEN();
                 * VeterinaryManagerGenNHibernate.CEN.Mediaplayer.ArtistCEN artistCEN = new VeterinaryManagerGenNHibernate.CEN.Mediaplayer.ArtistCEN();
                 * VeterinaryManagerGenNHibernate.CEN.Mediaplayer.UserCEN userCEN = new VeterinaryManagerGenNHibernate.CEN.Mediaplayer.UserCEN();
                 * VeterinaryManagerGenNHibernate.CEN.Mediaplayer.MusicTrackCEN musicTrackCEN = new VeterinaryManagerGenNHibernate.CEN.Mediaplayer.MusicTrackCEN();
                 * VeterinaryManagerGenNHibernate.CEN.Mediaplayer.PlayListCEN playListCEN = new VeterinaryManagerGenNHibernate.CEN.Mediaplayer.PlayListCEN();
                 *
                 *              //Add Users
